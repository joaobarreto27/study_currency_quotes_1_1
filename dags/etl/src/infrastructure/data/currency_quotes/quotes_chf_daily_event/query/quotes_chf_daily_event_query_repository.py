"""Módulo para buscar dados diários de cotação do CHF."""
...
class QuotesChfDailyEventQueryRepository:
    """Repositório para consultas diárias a cotações de CHF para BR."""
