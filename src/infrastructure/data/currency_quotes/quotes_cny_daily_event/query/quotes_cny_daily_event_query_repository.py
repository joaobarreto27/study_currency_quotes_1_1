"""Módulo para buscar dados diários de cotação do CNY."""
...
class QuotesCnyDailyEventQueryRepository:
    """Repositório para consultas diárias a cotações de CNY para BR."""
