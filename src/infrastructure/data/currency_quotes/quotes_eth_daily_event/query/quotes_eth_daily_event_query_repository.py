"""Módulo para buscar dados diários de cotação do ETH."""
...
class QuotesEthDailyEventQueryRepository:
    """Repositório para consultas diárias a cotações de ETH para BR."""
    ...
    def fetch(self) -> dict[str, Any]:
        """Realiza a busca dos dados da API."""
